...
<div class="post-layout post-layout--aside-last">
  <aside class="post-meta">
      <h2>important links</h2>
    <ul>
      <li><a href="https://foid.space/about">foid.space</a></li>
      <li><a href="https://github.com/abbyfluoroethane/abbyfluoroethane.github.io">website repo</a></li>
    </ul>
    <h2>things i like</h2>
    <ul>
      <li>New Glenn</li>
      ...
      <li><a href="https://zackerthescar.com">my wife &lt;3</a></li>
    </ul>
    <h2>contact</h2>
    <ul>
      <li><strong>Email:</strong> abby@bigaouette.com</li>
      <li><strong>Fedi:</strong> @abbyfluoroethane@tech.lgbt</li>
      <li><strong>Instagram:</strong> @abbyfluoroethane</li>
    </ul>
  </aside>
